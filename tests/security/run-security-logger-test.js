/**
 * Simple test runner for SecurityLogger
...
global.expect = function(value) {
  return {
    ...
    not: {
      ...
      toMatch: (regex) => {
        if (regex.test(value)) {
          throw new Error(`Expected ${JSON.stringify(value)} not to match ${regex}`);
        }
      }
    },
...
// Run the tests
console.log('\n🧪 Running SecurityLogger Tests\n');
console.log('═'.repeat(60));

// Execute the test file
require('./security-logger.test.js');
